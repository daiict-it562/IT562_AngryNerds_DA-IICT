...
ratings_dataFrame1 = pd.read_csv('rating_data_200k.csv', dtype={'rating': float})
...
ratings_dataFrame2 = pd.read_csv('rating_data_200k.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
...
ratings_dataFrame3 = pd.read_csv('rating_data_200k.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
...
ratings_dataFrame4 = pd.read_csv('rating_data_400k.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
...
ratings_dataFrame5 = pd.read_csv('rating_data_400k.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
...
ratings_dataFrame6 = pd.read_csv('rating_data_400k.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
...
ratings_dataFrame7 = pd.read_csv('rating_data_700k.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
...
ratings_dataFrame8 = pd.read_csv('rating_data_700k.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
...
ratings_dataFrame9 = pd.read_csv('rating_data_700k.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
...
ratings_dataFrame10 = pd.read_csv('rating_data_1m.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
...
ratings_dataFrame11 = pd.read_csv('rating_data_1m.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
...
ratings_dataFrame12 = pd.read_csv('rating_data_1m.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
